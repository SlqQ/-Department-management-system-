...
$groupArr=explode(" ",$_SESSION["groupArr"]);

$str="";
foreach($groupArr as $value){
$sql="select group_name from emailgroup where group_id='$value'";
...
<li class="cur">普通邮件</li>
	...
	<form action="mail_addressbook_send_groupmem_form_db.php" method="post" class="write_form" name='write_form' class="on" accept-charset="utf-8">
