<?php
		...
		$_SESSION["notice_image"]=$filePath;
        ...
        echo "<script>";
    	echo "alert('上传成功!!!');";
    	echo "window.parent.document.getElementById('notice_image').src='".$_SESSION['notice_image']."';";
    	echo "window.location.href='notice_upload_Image.php'";
		echo "</script>";
?>