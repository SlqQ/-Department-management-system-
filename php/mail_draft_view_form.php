...
include("conn.php");
    ...
    $sql="select user_name from user where job_number='".$_SESSION["userid"]."';";
    $rs=mysqli_query($conn,$sql);
	$row=mysqli_fetch_array($rs);
	...
	echo "<div class='mail_container'>
			   ...
			   echo " <div>附件：
			     ...
			     echo" <a href='mail_draft_view_add.php?email_id=".$email_id."' class='oper_eml'>发送</a>
			    
			      
			    <a href='mail_draft_view_delete.php?email_id=".$email_id."' class='oper_eml'>删除</a>
	     </div>";
    $rs=mysqli_query($conn,$sql);
 ?>
