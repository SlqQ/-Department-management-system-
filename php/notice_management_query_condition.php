...
<fieldset class="query_condition">
	<!-- <legend>查询条件</legend> -->
	<form action="<?php if($_SESSION['userid']==1) echo 'notice_management_query.php?export=-1'; else echo 'index.php?export=-1';?>" method="post" accept-charset="utf-8" class="query_form">
