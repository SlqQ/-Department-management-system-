...
<?php 
 ...
 <div class = "editBtn">
 		<?php 
			echo "<a href='staff_management_update_view.php?job_number=$row[0]' class = 'edit'title=''>编辑</a>";
	?></div>
 <form action="personal_information_update_db.php" method="post" accept-charset="utf-8" class="personal_information" name = "personal_information_form" id = "personal_information_form">
	...
	<label class="personal_img">
		...
		<!-- <iframe frameborder="0" src="upload.php" id = "information_iframe"></iframe>  -->
		<!-- <button class = "button updateBtn" type="button" name="" id = "button4">确定</button> -->
	...
	<div class = "view_lab">	
		...
		<label class="view_userIpt">
			...
			<!-- <a href="personal_information.php" class = "cancel" id = "cancel1">取消</a> -->
		</label>
		...
		<label class="view_userIpt">
			...
			<!-- <a href="personal_information.php" class = "cancel" id = "cancel2">取消</a> -->
		</label>
		...
		<label class="view_userIpt">
			...
			<!-- <a href="personal_information.php" class = "cancel" id = "cancel3">取消</a> -->
		</label>
